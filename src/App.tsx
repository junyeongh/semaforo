...
import { formatTime } from "./computations";
        ...
        setTimeLeft((prev: number) => {
          if (prev <= 1) {
            ...
            return getInitialTime(
              currentState === "focus" ? "transition" : currentState === "transition" ? "break" : "focus",
            );
          }
          return prev - 1;
        });
    ...
    <div className="h-screen bg-gray-100 flex items-center justify-center">
      <div className="bg-white rounded-lg shadow-2xl w-96 h-96 relative overflow-hidden">
        ...
        <div className="absolute top-4 left-4 flex space-x-2">
          {!isRunning ? (
            <Button handleClick={() => setIsRunning(true)}>
              <Play size={18} />
            </Button>
          ) : (
            <Button handleClick={() => setIsRunning(false)}>
              <Pause size={18} />
            </Button>
          )}
        ...
        <div
          ...
          style={{
            transform: settingsOpen ? `translateY(${dragOffset}px)` : "translateY(100%)",
              ...
              <div className="flex items-center justify-between">
                ...
                <input
                  ...
                  onChange={(e: any) =>
                    setStateDurations({
                      ...stateDurations,
                      focus: parseInt(e.target.value) || 40,
                    })
                  }
              ...
              <div className="flex items-center justify-between">
                ...
                <input
                  ...
                  onChange={(e: any) =>
                    setStateDurations({
                      ...stateDurations,
                      transition: parseInt(e.target.value) || 10,
                    })
                  }
                  className="w-20 p-1 border border-gray-300 rounded text-center"
                  min="1"
              ...
              <div className="flex items-center justify-between">
                ...
                <input
                  ...
                  onChange={(e: any) =>
                    setStateDurations({
                      ...stateDurations,
                      break: parseInt(e.target.value) || 20,
                    })
                  }
                  className="w-20 p-1 border border-gray-300 rounded text-center"
                  min="1"
